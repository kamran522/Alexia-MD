...
module.exports = arxzy = async (arxzy, m, msg, chatUpdate, store) => {
    try {
        ...
        const isAdrian = ('6283892216115@s.whatsapp.net').includes(m.sender)
        /* ~~~~~~~~~ GROUP SYSTEM ~~~~~~~~~ */
...
item2.EMAIL;type=INTERNET:zorsatoru@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://linkbio.co/ZorsMD\n
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
        ...
        switch (isCommand) {
            ...
            case 'statusbot': {
                ...
                respon = `
Kecepatan Alexia - MD ${latensi.toFixed(4)} _Second_ \n ${oldd - neww} _miliseconds_\n\nRuntime : ${runtime(process.uptime())}
                ...
                arxzy.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: 'Script Free',
                            body: `SCRIPT BOT ${namabot} Ada Di Telegram @Ohmyputx`,
            ...
            */
            ...
            case 'ytmp4': {
                ...
                await arxzy.sendMessage(m.chat, {
                    ...
                    mimetype: 'video/mp4',
                    fileName: "Downloader Ytmp4 By Zors.mp4",
                    caption: ytmp4p,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
            ...
            case 'ytmp3': {
                ...
                await arxzy.sendMessage(m.chat, {
                    ...
                    mimetype: 'audio/mp3',
                    fileName: "Downloader Ytmp3 By Zors.mp3",
                    caption: ytmp4p,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
